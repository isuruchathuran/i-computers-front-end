...
export default function DeleteModal(props){
    ...
    return(
        <div>
            <FaTrash onClick={()=>{setIsVisible(true)}} className ="hover:text-red-500 cursor-pointer" />
            {
                isVisible && (
                    <div className="fixed z-100 bg-black/50 w-screen h-screen top-0 left-0 flex justify-center items-center">
                            <div className="w-[400px] bg-amber-50 h-[200px] relative">
                                ...
                                )}}className="w-[40px] h-[40px] text-red-600 absolute right-0 text-sm-end font-bold hover:bg-red-600 hover:text-white cursor-pointer">
                                    X
                                </button>
